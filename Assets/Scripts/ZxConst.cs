...
public enum ZxConst {
    ...
    JSON_EVENT_TYPE_CARD_MOVE   = 1,
    JSON_EVENT_TYPE_USE_EFFECT = 2,
    JSON_EVENT_TYPE_CHOOSE = 3,
    JSON_EVENT_TYPE_UPDATE_CARD_STATE = 4,

    CHOOSE_TYPE_MESSAGE   = 1,
    CHOOSE_TYPE_CARD      = 2,
    CHOOSE_TYPE_EFFECT    = 3,
    CHOOSE_TYPE_SQUARE    = 4,
    CHOOSE_TYPE_ZONE      = 5,

    // location
    LOCATION_DECK = 0x00001,
    LOCATION_HAND = 0x00002,
    LOCATION_SQUARE = 0x01000,
    LOCATION_TRASH = 0x02000,
    LOCATION_REMOVED = 0x04000,
    LOCATION_FORCE = 0x08000,
    LOCATION_CHARGE = 0x10000,
    LOCATION_LIFE = 0x20000,
    LOCATION_RESOURCE = 0x40000,
    LOCATION_TEMPORARY = 0x80000,
    // square location
    SQUARE_LOCATION_1 = 0x00004,
    SQUARE_LOCATION_2 = 0x00008,
    SQUARE_LOCATION_3 = 0x00010,
    SQUARE_LOCATION_4 = 0x00020,
    SQUARE_LOCATION_5 = 0x00040,
    SQUARE_LOCATION_6 = 0x00080,
    SQUARE_LOCATION_7 = 0x00100,
    SQUARE_LOCATION_8 = 0x00200,
    SQUARE_LOCATION_9 = 0x00400,
    SQUARE_LOCATION_F = 0x00800,

    // square state
    SQUARE_EXIST_ZX = 0x00001,
    SQUARE_NOT_EXIST_ZX = 0x00002,
    SQUARE_EXIST_FRIEND_ZX = 0x00004,
    SQUARE_EXIST_ENEMY_ZX = 0x00008,
    SQUARE_PLAYER = 0x00004,
    SQUARE_NOT_PLAYER = 0x00004,
    SQUARE_ENEMY_PLAYER = 0x00004,
    SQUARE_FRIEND_PLAYER = 0x00008,
    // Positions
    POS_SLEEP = 0x1,
    POS_REBOOT = 0x2,
